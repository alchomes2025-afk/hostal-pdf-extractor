...
# Fuente: export manual de Beds24. Solo lectura para mostrar en la app.
# Los overrides del usuario se guardan en Beds24 via POST y tienen prioridad.
BASE_PRICES = {
    702395: {
        "2026-07-20": 70.0,
        "2026-07-21": 70.0,
...
def mobile_calendar():
    ...
    try:
        ...
        # ── 4. Construir precios diarios: BASE_PRICES + overrides ──────────
