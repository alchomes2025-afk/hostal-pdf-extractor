...
def descargar_adjunto_gmail(message_id, access_token):
    ...
    # 2. Buscar la parte que es PDF (busqueda plana + recursiva)
...
def habitacion_desde_nombre_archivo(pdf_filename):
    """
    Extrae el nombre de habitacion del nombre del PDF.
    Ej: "Habitacion Simple 2_09-06-2026.pdf" -> "Habitación Simple 2"
    Ej: "Habitacion Deluxe 5_08-06-2026.pdf" -> "Habitación Deluxe 5"
    """
    nombre_base = pdf_filename.replace(".pdf", "")
    # Quitar la parte de la fecha (patron _DD-MM-YYYY o _YYYY-MM-DD al final)
    ...
    # Buscar "Habitacion" o "Habitación" en el nombre y tomar todo desde ahi
